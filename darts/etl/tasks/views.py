...
from .scrapers import EventScraper
from darts.etl import base, mixins


class StatsSince2015View(
        mixins.DailyTaskMixin,
        base.PostgresMaterialisedViewBase,
        ):

    table = 'stats_since_2015'
    ...
    columns = ['player_name', 'oneeighties', 'legs', 'oneeighties_per_leg']

    def requires(self):
        yield EventScraper(date=self.date)
